...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://emicoder.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("cellokrecik@interia.pl");
        driverTrello.findElement(By.id("password")).sendKeys("Ltracz070680!");
